...
Developer-friendly & type-safe Typescript SDK specifically catered to leverage *orq-poc-typescript* API.

<div align="left">
    <a href="https://www.speakeasy.com/?utm_source=orq-poc-typescript&utm_campaign=typescript"><img src="https://custom-icon-badges.demolab.com/badge/-Built%20By%20Speakeasy-212015?style=for-the-badge&logoColor=FBE331&logo=speakeasy&labelColor=545454" /></a>
...
```bash
npm add orq-poc-typescript2
```

### PNPM

```bash
pnpm add orq-poc-typescript2
```

### Bun

```bash
bun add orq-poc-typescript2
```

### Yarn

```bash
yarn add orq-poc-typescript2 zod
...
* [create3](docs/sdks/contacts/README.md#create3) - Update user information
...
- [`contactsCreate3`](docs/sdks/contacts/README.md#create3) - Update user information
...
import {
  HonoApiError,
  SDKValidationError,
} from "orq-poc-typescript2/models/errors";
...
```typescript
import { Orq } from "orq-poc-typescript2";
import { HTTPClient } from "orq-poc-typescript2/lib/http";
...
### SDK Created by [Speakeasy](https://www.speakeasy.com/?utm_source=orq-poc-typescript&utm_campaign=typescript)
