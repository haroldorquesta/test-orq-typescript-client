...
async function run() {
  await orq.deployments.deleteV2DeploymentsInvalidateDeploymentId("2f8f323e-7a21-40c4-8729-612ffe6e2dcb");
...
async function run() {
  const res = await deploymentsDeleteV2DeploymentsInvalidateDeploymentId(orq, "2f8f323e-7a21-40c4-8729-612ffe6e2dcb");
