...
| `type`                                                                                                                                                                 | [operations.PostV2DeploymentsGetConfigDeploymentsResponseType](../../models/operations/postv2deploymentsgetconfigdeploymentsresponsetype.md)                           | :heavy_minus_sign:                                                                                                                                                     | The type of the model. Current `chat`,`completion` and `image` are supported                                                                                           |
