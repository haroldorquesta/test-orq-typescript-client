 ...
 */
export type RouterRerankRequestBody = {
  /**
   * The search query
   */
  query: string;
 ...
 */
export type RouterRerankResponseBody = {
  /**
...
/** @internal */
export type RouterRerankRequestBody$Outbound = {
  query: string;
  documents: Array<string | { [k: string]: string }>;
  model: string;
...
/** @internal */
export const RouterRerankRequestBody$outboundSchema: z.ZodType<
  RouterRerankRequestBody$Outbound,
  z.ZodTypeDef,
  RouterRerankRequestBody
> = z.object({
  query: z.string(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace RouterRerankRequestBody$ {
  /** @deprecated use `RouterRerankRequestBody$inboundSchema` instead. */
  export const inboundSchema = RouterRerankRequestBody$inboundSchema;
  /** @deprecated use `RouterRerankRequestBody$outboundSchema` instead. */
  export const outboundSchema = RouterRerankRequestBody$outboundSchema;
  /** @deprecated use `RouterRerankRequestBody$Outbound` instead. */
...
/** @internal */
export type RouterRerankResponseBody$Outbound = {
  id?: string | undefined;
...
/** @internal */
export const RouterRerankResponseBody$outboundSchema: z.ZodType<
  RouterRerankResponseBody$Outbound,
  z.ZodTypeDef,
  RouterRerankResponseBody
> = z.object({
  id: z.string().optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace RouterRerankResponseBody$ {
  /** @deprecated use `RouterRerankResponseBody$inboundSchema` instead. */
  export const inboundSchema = RouterRerankResponseBody$inboundSchema;
  /** @deprecated use `RouterRerankResponseBody$outboundSchema` instead. */
